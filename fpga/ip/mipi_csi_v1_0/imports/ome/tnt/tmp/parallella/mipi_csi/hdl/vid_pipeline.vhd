	...
	begin
		if rising_edge(clk) then
			case ctrl_vfm is
				...
				when others =>
					vfm_data(31 downto 16) <= (vcol_red(7 downto 3) & vcol_green(7 downto 2) & vcol_blue(7 downto 3));
                    vfm_data(15 downto 0)  <= (vcol_red(7 downto 3) & vcol_green(7 downto 2) & vcol_blue(7 downto 3));
                    vfm_last  <= vcol_last;
                    vfm_sof   <= vcol_sof;
                    vfm_valid <= vcol_valid;
			end case;
